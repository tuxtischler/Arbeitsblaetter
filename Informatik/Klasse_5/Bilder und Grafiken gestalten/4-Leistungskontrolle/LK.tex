...
\aufgabe{}{2}{Das Logo sollte besser eine Vektorgrafik werden (1P.), da Rastergrafiken beim Vergrößern verpixeln. Eine Vektorgrafik kann hingegen vergrößert werden, ohne, dass sie verpixeln (1P.).}
\large Deine Schule möchte ein neues Logo gestalten. Dieses soll vielfältig eingesetzt werden können (z.B. Pullover, Flaggen, Wandbilder). Die Schulleitung fragt dich nach deiner Meinung, ob das Logo als Rastergrafik oder als Vektorgrafik erstellt werden soll.\newline Entscheide dich, ob das Logo eine Vektorgrafik oder eine Rastergrafik sein soll und begründe deine Entscheidung.
\liniert{3}
